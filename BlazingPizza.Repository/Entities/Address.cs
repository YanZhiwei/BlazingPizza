...
public class Address
{
    ...
    [Required]
    [MinLength(5, ErrorMessage = "Please use an Address bigger than 5 letters.")]
    ...
    [Required]
    [MinLength(3, ErrorMessage = "Please use a City bigger than 3 letters.")]
    [MaxLength(50, ErrorMessage = "Please use a City less than 50 letters.")]
    public string City { get; set; }

    [Required]
    [MinLength(3, ErrorMessage = "Please use a Region bigger than 3 letters.")]
